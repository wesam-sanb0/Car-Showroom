...
public class LogInCustumer extends javax.swing.JFrame {

    /**
     * Creates new form LogInCustumer
     */
    public LogInCustumer() {
        super("LogIn Custumer");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        EmailTxt.setToolTipText("enter you email corectly");
        EmailTxt.setPreferredSize(new java.awt.Dimension(869, 606));
        ...
        IdTxt.setText("Value");
        IdTxt.setToolTipText("enter your id corectly");
        ...
        backButton.setToolTipText("to go back to last page");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(EmailTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 292, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.getAccessibleContext().setAccessibleName("login for customer");
    ...
    int customerID = query.getVerifiedCustomerID(email, id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogInCustumer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
