 ...
 * @author Amal
 */
public class SignUpCustumer extends javax.swing.JFrame {

    /**
     * Creates new form JFrameOne
     */
    public SignUpCustumer() {
        super("SignUp Custumer");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(200, 40));
        ...
        jButton1.setToolTipText("to Submit");
        ...
        jButton2.setToolTipText("to go Back");
        ...
        jPanel1.getAccessibleContext().setAccessibleName("signUp for customer");
    ...
    String zip = jTextField7.getText().trim();
    String city = jTextField8.getText().trim();
    String street = jTextField9.getText().trim();
    String state = jTextField10.getText().trim();
    
    if (firstName.isEmpty() || lastName.isEmpty() || email.isEmpty() || id.isEmpty() || phone.isEmpty()) {
    ...
    query.insertCustomer(id, firstName, middleName, lastName, email, phone, zip, city, street, state);
    new LogInCustumer().setVisible(true);
    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignUpCustumer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SignUpCustumer().setVisible(true);
        });
    }
