...
public class SignUpEmployee extends javax.swing.JFrame {
    ...
    if (firstName.isEmpty() || lastName.isEmpty() || email.isEmpty() || phone.isEmpty() || id.isEmpty()) {
    ...
    query.insertEmployee(id, firstName, middleName, lastName, email, phone);
